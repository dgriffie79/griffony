Onyx.register_module("__webgl", instance => ({
    ...
    // added by me
    glTexImage3DSource(target, level, internalformat, width, height, depth, border, format, type, source) {
        instance.gl.texImage3D(target, level, internalformat, width, height, depth, border, format, type, instance.load_value(source));
    },
    glTexImage3DSrcData(target, level, internalformat, width, height, depth, border, format, type, pixels, pixelslen) {
        const data = new Uint8Array(instance.memory.buffer, pixels, pixelslen);
        instance.gl.texImage3D(target, level, internalformat, width, height, depth, border, format, type, data);
    },
    ...
    glTexStorage3D(target, levels, internalformat, width, height, depth) {
        instance.gl.texStorage3D(target, levels, internalformat, width, height, depth);
    },
    ...
    glTexSubImage3D(target, level, xoff, yoff, zoff, width, height, depth, format, type, pixels) {
        instance.gl.texSubImage3D(target, level, xoff, yoff, zoff, width, height, depth, format, type, instance.load_value(pixels));
    },
    glUniform1f(loc, x) {
    ...
    glUniform1uiv(loc, valueptr, valuelen) {
        instance.gl.uniform1uiv(instance.glState.uniformlocs[loc], new Uint32Array(instance.memory.buffer, valueptr, valuelen));
    },
